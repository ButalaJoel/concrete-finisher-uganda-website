    ...
    <section className="services-grid-section">
      ...
      <div className="container">
        ...
        <div className="services-page-grid">
          ...
          <Link to="/services/epoxy-flooring" className="services-page-card">
          ...
          <Link to="/services/concrete-polishing" className="services-page-card">
          ...
          <Link to="/services/surface-preparation" className="services-page-card">
          ...
          <Link to="/services/terrazzo-flooring" className="services-page-card">
          ...
          <Link to="/services/concrete-stamping" className="services-page-card">
          ...
          <Link to="/services/waterproofing" className="services-page-card">
